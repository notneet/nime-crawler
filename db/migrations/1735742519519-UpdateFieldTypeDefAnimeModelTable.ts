...
export class UpdateFieldTypeDefAnimeModelTable1735742519519 implements MigrationInterface {
    name = 'UpdateFieldTypeDefAnimeModelTable1735742519519'

    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`DROP INDEX \`IDX_e583120e6941c7147cf6bc059a\` ON \`anime_model\``);
        await queryRunner.query(`ALTER TABLE \`anime_model\` DROP COLUMN \`uuid\``);
        await queryRunner.query(`ALTER TABLE \`anime_model\` ADD \`uuid\` varchar(255) NOT NULL`);
        await queryRunner.query(`ALTER TABLE \`anime_model\` ADD UNIQUE INDEX \`IDX_e583120e6941c7147cf6bc059a\` (\`uuid\`)`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE \`anime_model\` DROP INDEX \`IDX_e583120e6941c7147cf6bc059a\``);
        await queryRunner.query(`ALTER TABLE \`anime_model\` DROP COLUMN \`uuid\``);
        await queryRunner.query(`ALTER TABLE \`anime_model\` ADD \`uuid\` longtext NULL DEFAULT 'NULL'`);
        await queryRunner.query(`CREATE UNIQUE INDEX \`IDX_e583120e6941c7147cf6bc059a\` ON \`anime_model\` (\`uuid\`)`);
    }
